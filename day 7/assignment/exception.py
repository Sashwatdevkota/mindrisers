...
# if a is greater than b print a statement {a} is greater than {b}
# if a is less than b
...
# if the mark is greater than 100 and less than 0, print a statement
# if the mark is greater than 90 and less then 100, print a statement("Excellent")
...
# if the mark is less than 40, print a statement
# ask if they want to continue: yes: iterate the code, no: terminate the loop


# define a dictionary username as key and password as value
# get the username and password from the user
# check if the username exists in the diction
